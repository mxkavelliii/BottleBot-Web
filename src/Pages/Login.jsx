...
const Login = () => {
  ...
  return (
    <div className="h-[100svh] w-full flex items-center justify-center bg-login bg-cover bg-center font-inter">
      <div className="w-full h-full flex items-center justify-center bg-gradient-to-tr from-black/75 via-gray-200/50 to-black/50">
        <div className="flex flex-col items-center justify-center bg-[#fdfdff] py-3 px-6 bg- border-[#222326] rounded-xl shadow-xl">
          ...
          <div className="w-full flex flex-col gap-4 items-center justify-center py-4">
            ...
            <div className="w-full flex flex-col items-start justify-center gap-1">
              ...
              <div className="w-full flex flex-row gap-1 items-center justify-center rounded-md overflow-hidden bg-[#f3edff] focus:border border-black py-2">
                <div className="px-2 w-full border-r border-gray-400/75">
                  <RiUser4Line className="text-sm text-black" />
                </div>
                <input
                  type="text"
                  className="bg-[#f3edff] text-xs outline-none min-w-[200px] px-2 truncate"
            ...
            <div className="w-full flex flex-col items-start justify-center gap-1">
              ...
              <div className="w-full flex flex-row gap-1 items-center justify-center rounded-md overflow-hidden bg-[#f3edff] focus:border border-black py-2">
                ...
                <input
                  type="password"
                  className="bg-[#f3edff] text-xs outline-none min-w-[200px] px-2"
                  placeholder="•••••••••••"
                />
              </div>
            </div>
          ...
          <div className="w-full flex items-center justify-center py-4">
            <div className="w-full py-2 bg-[#303030] rounded-md flex items-center justify-center cursor-pointer hover:bg-[#1c1c1c] ease-in-out duration-500">
